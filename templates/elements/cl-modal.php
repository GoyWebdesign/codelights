 ...
 *
 * @var $title string Modal box title
 * @var $content string Modal box content
 * @var $show_on string Show modal on: 'btn' / 'image' / 'text' / 'load' / 'exit'
 ...
 * @var $text_olor string Text color
 ...
 * @var $overlay_opacity int Overlay opacity in percents
 * @var $header_bgcolor string Header background color
 * @var $header_textcolor string Header text color
 * @var $content_bgcolor string Content background color
 * @var $content_textcolor string Content text color
 * @var $border_size int Border width
