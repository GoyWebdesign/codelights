	...
	'cl-ib' => array(
		...
		'params' => array(
			...
			array(
				...
				'heading' => __( 'Heading and Icon Font Size', 'codelights' ),
				'description' => __( 'In percents, relative to container width', 'codelights' ),
				'type' => 'textfield',
				'std' => '8%',
				'edit_field_class' => 'vc_col-sm-6 vc_column',
				'group' => __( 'General Settings', 'codelights' ),
			...
			array(
				...
				'heading' => __( 'Text and Button Font Size', 'codelights' ),
				'description' => __( 'In percents, relative to container width', 'codelights' ),
				'type' => 'textfield',
				'std' => '6%',
				'edit_field_class' => 'vc_col-sm-6 vc_column',
