...
return array(
	...
	'cl-modal' => array(
		...
		'description' => __( 'Dialog box displayed on the top of page content', 'codelights' ),
		'category' => 'CodeLights',
		...
		'params' => array(
			...
			'show_on' => array(
				...
				'options' => array(
					...
					'leave' => __( 'User Leaving', 'codelights' ),
				),
				'std' => 'btn',
			),
			'btn_label' => array(
			...
			'animation' => array(
				...
				'type' => 'select',
				'options' => array(
					// TODO Choose a list of animations to be created
					// Inspirational links:
					...
					// http://justcapelle.com/css3-slick-modal-popups/
				),
			),
